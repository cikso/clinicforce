          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h2 className="text-xl font-bold text-slate-900">
                <span className="text-[#00BFA5]">{caseData?.patientName}</span>
                {' '}— {caseData?.breed}
              </h2>
        ...
        <div className="flex-1 overflow-y-auto bg-white">
          <div className="p-6 space-y-8">
            ...
            <section>
              ...
              <div className="bg-[#E0F7F3] border border-[#bae6fd] rounded-2xl p-5">
            ...
            <section>
              ...
              <div className="flex items-center gap-3 bg-slate-50 rounded-xl p-4">
                <div className={`w-2.5 h-2.5 rounded-full ${caseData?.urgency === 'CRITICAL' ? 'bg-[#b91c1c] animate-pulse' : 'bg-[#00BFA5]'}`} />
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    <button className="text-xs font-bold text-[#00BFA5] flex items-center gap-1 hover:text-[#00A98E] transition-colors">
            ...
            <section>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[10px] font-bold text-[#00BFA5] bg-teal-50 px-2 py-0.5 rounded-full">3 Assets</span>
              </div>
        ...
        <div className="p-6 border-t border-slate-100 bg-white shrink-0">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 py-3.5 bg-[#00BFA5] text-white font-bold rounded-full hover:bg-[#00A98E] transition-colors text-sm"
            >
              Approve &amp; Assign
            </button>
            <button
