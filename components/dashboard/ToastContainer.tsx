...
const variantConfig = {
  ...
  info: { bg: 'bg-white border-l-4 border-l-[#0f5b8a]', icon: <Info className="w-4 h-4 text-[#0f5b8a]" />, iconBg: 'bg-blue-50' },
}
...
function Toast({ toast, onDismiss }: { toast: ToastItem; onDismiss: (id: string) => void }) {
  ...
  return (
    <div
      className={`flex items-center gap-3 px-4 py-3 rounded-xl shadow-lg border border-slate-200 min-w-[280px] max-w-[360px] transition-all duration-300 ${cfg.bg} ${
