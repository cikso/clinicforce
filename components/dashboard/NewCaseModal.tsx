        ...
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg pointer-events-auto">
          ...
          <div className="flex items-center justify-between p-6 border-b border-slate-100">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-[#00BFA5] flex items-center justify-center">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm font-medium focus:ring-2 focus:ring-[#00BFA5]/20 focus:border-[#00BFA5] outline-none"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm font-medium focus:ring-2 focus:ring-[#00BFA5]/20 focus:border-[#00BFA5] outline-none bg-white"
                >
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                type="submit"
                disabled={triaging}
                className="flex-1 py-3 bg-[#00BFA5] text-white font-bold rounded-full hover:bg-[#00A98E] transition-colors text-sm disabled:opacity-70 flex items-center justify-center gap-2"
              >
                {triaging ? (
                  <>
