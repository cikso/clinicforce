  ...
  const handleNewCase = useCallback(
    (partial: Partial<DashboardCase>) => {
      const newCase: DashboardCase = {
        ...
        waitMinutes: 0,
        aiSummary: partial.aiSummary ?? 'Manual intake — AI triage pending.',
        status: 'WAITING',
        clinician: null,
        clinicianAvatar: null,
        source: partial.source ?? 'FRONT_DESK',
        riskFactor: partial.riskFactor ?? 'Pending AI triage',
        urgencyScore: partial.urgencyScore ?? (partial.urgency === 'CRITICAL' ? 8.0 : partial.urgency === 'URGENT' ? 5.0 : 2.0),
        aiJustification: partial.aiJustification ?? 'Case manually entered — AI triage analysis queued.',
