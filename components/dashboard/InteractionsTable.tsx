      ...
      <div className="bg-white rounded-xl border border-slate-200/70 shadow-[0_1px_3px_rgba(15,39,68,0.06)] overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          <div>
            ...
            <p className="text-[11px] text-slate-400 mt-0.5">No interactions yet — ClinicForce is standing by</p>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-[11px] text-slate-400">Interactions handled by ClinicForce will appear here</p>
        </div>
      </div>
    )
  }
