  ...
  return (
    <>
      ...
      <div className="flex items-end justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-[#17C4BE] mb-1">Active Care Queue</h1>
          ...
          {(['pending', 'active', 'discharged'] as TabFilter[]).map((t) => (
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-semibold transition-colors ${
                tab === t ? 'bg-white shadow-sm text-[#17C4BE]' : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              {t === 'pending'
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col justify-between h-36">
          ...
          <div>
            <h3 className="text-4xl font-bold text-[#17C4BE] mb-1">{mockStats.avgWaitMinutes}m</h3>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col justify-between h-36">
          ...
          <div>
            ...
            <div className="w-full flex h-2.5 rounded-full overflow-hidden bg-slate-100">
              <div className="bg-[#17C4BE] rounded-full" style={{ width: '70%' }} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div className="px-8 py-4 border-t border-slate-100 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="w-8 h-8 flex items-center justify-center rounded-full bg-[#17C4BE] text-white font-semibold text-sm">
              1
            </button>
