    ...
    return (
      <div className="w-full max-w-lg text-center">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3.5 bg-[#00D68F] hover:bg-[#0e4f79] text-white text-sm font-bold rounded-xl transition-colors"
        >
    ...
    <div className="w-full max-w-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[#00D68F] hover:bg-[#0e4f79] text-white text-sm font-bold rounded-xl transition-colors disabled:opacity-40 disabled:cursor-not-allowed mt-2"
        >
