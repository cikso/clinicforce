        ...
        <div className="flex-1 flex flex-col gap-8">
          ...
          <section>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <PlusSquare className="w-6 h-6 text-[#0f5b8a]" />
          ...
          <section>
            <div className="flex items-center gap-3 mb-6">
              <Compass className="w-6 h-6 text-[#0f5b8a]" />
        ...
        <div className="w-96 shrink-0">
          <div className="bg-slate-50 rounded-[2.5rem] p-8 h-full flex flex-col border border-slate-100 shadow-sm">
            <div className="flex items-center gap-3 mb-8">
              <Zap className="w-6 h-6 text-[#0f5b8a]" />
            ...
            <div className="space-y-6 flex-1">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-5 pr-12 py-4 bg-white border border-slate-200 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#0f5b8a]/20 outline-none placeholder:text-slate-400 shadow-sm"
                  />
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full pl-5 pr-12 py-4 bg-white border border-slate-200 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#0f5b8a]/20 outline-none appearance-none text-slate-900 shadow-sm"
                  >
                    {mockPartnerClinics
              ...
              <div className="bg-white rounded-[1.5rem] p-5 border border-slate-200 shadow-sm">
                <div className="flex items-center gap-2 mb-3">
                  <Bot className="w-5 h-5 text-[#0f5b8a]" />
                  <span className="text-[11px] font-bold text-[#0f5b8a] uppercase tracking-widest">
                    AI Triage Summary
                  </span>
                </div>
            ...
            <button className="w-full py-4 bg-[#0f5b8a] text-white rounded-full text-base font-bold hover:bg-[#0c4a70] transition-colors flex items-center justify-center gap-2 shadow-sm mt-8">
...
function ReferralCard({ referral }: { referral: Referral }) {
  ...
  const borderColor = isStat ? 'border-l-[#b91c1c]' : 'border-l-[#0f5b8a]'
  const iconBg = isStat ? 'bg-red-100 text-[#b91c1c]' : 'bg-blue-100 text-[#0f5b8a]'
  const stepColor = isStat ? '#b91c1c' : '#0f5b8a'
  const badgeBg = isStat ? 'bg-[#b91c1c] text-white' : 'bg-[#0f5b8a] text-white'
