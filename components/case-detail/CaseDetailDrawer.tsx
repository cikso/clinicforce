      ...
      >
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-slate-500 uppercase tracking-wider">
                <span className="text-[var(--brand)]">{entry.patient.name.toUpperCase()}</span>
                {' '}|{' '}
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8">
          ...
          <section>
            ...
            <div className="bg-[var(--brand-light)] border border-[#bae6fd] rounded-3xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-white rounded-2xl p-4">
                  ...
                  <p className="text-[var(--brand)] font-bold text-sm">{entry.urgencyScore} / 10</p>
                </div>
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-4 mt-2">
                  <button className="text-xs font-bold text-[var(--brand)] flex items-center gap-1.5 hover:text-[var(--brand-hover)] transition-colors">
          ...
          <section>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="px-3 py-1 bg-[var(--brand-light)] text-[var(--brand)] text-[10px] font-bold rounded-full">
                3 Assets
              </span>
            </div>
        ...
        <div className="p-6 shrink-0 border-t border-slate-100 bg-white">
          ...
          <div className="flex gap-3">
            <button className="flex-1 py-3 bg-[var(--brand)] text-white font-bold rounded-full hover:bg-[var(--brand-hover)] transition-colors text-sm">
              Approve Booking
            </button>
