...
export default function NotificationsClient({ settings }: NotificationsClientProps) {
  ...
  const [slackWebhook, setSlackWebhook] = useState((settings?.slack_webhook_url as string) ?? '')
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    try {
      ...
      showToast(res.ok ? 'Notification preferences saved' : 'Failed to save', res.ok ? 'success' : 'error')
    } catch {
