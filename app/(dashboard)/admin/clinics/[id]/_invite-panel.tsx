...
export default function InvitePanel({ clinicId, clinicName, invites }: Props) {
  ...
  return (
    <div style={{ backgroundColor: '#ffffff', border: '1px solid #E8E4DE', borderRadius: 14, padding: '1.75rem' }}>
      ...
      {/* Success message */}
      {successMsg && (
        <div style={{ padding: '0.75rem 1rem', backgroundColor: 'rgba(27,107,74,0.06)', border: '1px solid rgba(27,107,74,0.2)', borderRadius: 10, fontFamily: "'DM Sans'", fontSize: '0.875rem', color: '#1B6B4A', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <div style={{ borderTop: '1px solid #F0EDE8', paddingTop: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
              {invites.map((inv, i) => {
                ...
                const statusColors = {
                  accepted: { bg: 'rgba(27,107,74,0.07)', color: '#1B6B4A', border: 'rgba(27,107,74,0.2)' },
                      ...
                      {status === 'pending' && (
                        <button
                          ...
                          style={{
                            ...
                            color: copiedToken === inv.token ? '#1B6B4A' : '#6B6B6B',
