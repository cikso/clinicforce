...
function StatusBadge({ item }: { item: CallInboxItem }) {
  ...
  if (item.status === 'UNREAD')
    return <span className="px-2 py-0.5 rounded text-[10px] font-semibold bg-[#e8f4fd] text-[#0176d3] border border-[#0176d3]/20">NEW</span>
  if (item.status === 'READ')
      ...
      <div className="px-6 py-5 border-b border-[#dddbda] flex-shrink-0">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex gap-2 flex-shrink-0">
            <button className="px-3.5 py-1.5 text-[13px] text-[#0176d3] font-medium border border-[#dddbda] rounded-md bg-white hover:bg-[#f4f6f9] transition-colors">
              Assign Task
            </button>
            <button className="px-3.5 py-1.5 text-[13px] text-[#0176d3] font-medium border border-[#dddbda] rounded-md bg-white hover:bg-[#f4f6f9] transition-colors">
              View History
            ...
            <button
              ...
              className={`px-5 py-2.5 text-white text-[13px] font-semibold rounded-md shadow-sm transition-all flex items-center gap-1.5 ${
                isUrgent
                  ...
                  : 'bg-[#0176d3] hover:bg-[#0052a3] shadow-blue-200/50'
              }`}
            >
        ...
        <div className="w-[288px] flex-shrink-0 flex flex-col border-r border-[#dddbda] bg-white overflow-hidden">
          ...
          <div className="px-4 py-3.5 border-b border-[#dddbda] flex items-center justify-between flex-shrink-0 bg-[#f4f6f9]">
            ...
            <div className="flex items-center gap-2">
              {unread > 0 && (
                <span className="text-[10px] font-bold text-[#0176d3] bg-[#e8f4fd] border border-[#0176d3]/20 px-2 py-0.5 rounded-full">
                  {unread} new
                </span>
              )}
