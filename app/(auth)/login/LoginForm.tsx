  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, #00BFA5 0%, #009680 100%)' }}
      >
        {/* Logo */}
        ...
        <div className="w-full max-w-[400px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link
                  ...
                  className="text-[12px] font-medium text-[#00BFA5] hover:text-[#009680] transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-11 rounded-lg border border-[#E5E7EB] bg-white text-[15px] text-[#111827] placeholder:text-[#9CA3AF] focus:border-[#00BFA5] focus:ring-2 focus:ring-[#00BFA5]/20 transition-all outline-none"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full h-12 flex items-center justify-center gap-2 rounded-lg bg-[#00BFA5] text-white text-[15px] font-semibold hover:bg-[#009680] active:scale-[0.98] transition-all disabled:opacity-60 disabled:cursor-not-allowed mt-1"
            >
              {isPending && (
