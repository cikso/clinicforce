  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, #0176D3 0%, #014486 100%)' }}
      >
        {/* Logo */}
        ...
        <div className="w-full max-w-[400px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link
                  ...
                  className="text-[12px] font-medium text-[#0176D3] hover:text-[#014486] transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-11 rounded-lg border border-[#E5E7EB] bg-white text-[15px] text-[#111827] placeholder:text-[#9CA3AF] focus:border-[#0176D3] focus:ring-2 focus:ring-[#0176D3]/20 transition-all outline-none"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full h-12 flex items-center justify-center gap-2 rounded-lg bg-[#0176D3] text-white text-[15px] font-semibold hover:bg-[#014486] active:scale-[0.98] transition-all disabled:opacity-60 disabled:cursor-not-allowed mt-1"
            >
              {isPending && (
