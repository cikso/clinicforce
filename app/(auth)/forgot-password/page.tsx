    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-[440px]">
        ...
        <div className="flex items-center gap-2.5 mb-8">
          <div className="w-9 h-9 rounded-lg bg-[#00BFA5] flex items-center justify-center">
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-xl p-8 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          {!sent ? (
            <>
              {/* Icon */}
              <div className="w-12 h-12 rounded-xl bg-[#E0F7F3] flex items-center justify-center mb-5">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#00BFA5" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-[#E5E7EB] bg-white text-[15px] text-[#111827] placeholder:text-[#9CA3AF] focus:border-[#00BFA5] focus:ring-2 focus:ring-[#00BFA5]/20 transition-all outline-none"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="w-full h-12 flex items-center justify-center gap-2 rounded-lg bg-[#00BFA5] text-white text-[15px] font-semibold hover:bg-[#009680] active:scale-[0.98] transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isPending && (
              ...
              <div className="mt-5 text-center">
                <Link href="/login" className="text-[13px] font-medium text-[#00BFA5] hover:text-[#009680] transition-colors">
                  Back to sign in
                </Link>
              </div>
            </>
            ...
            <div className="text-center py-4">
              ...
              <Link
                href="/login"
                className="inline-flex items-center gap-1.5 text-[13px] font-medium text-[#00BFA5] hover:text-[#009680] transition-colors"
              >
